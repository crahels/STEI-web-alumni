...
class MembersController extends Controller
{
    ...
    {
        $this->middleware('admin', ['except' => ['show', 'edit', 'update', 'showMyProfile', 'editMember', 'updateMyProfile']]);
    }
    ...
    public function updateMyProfile(Request $request, $id)
    {
        ...
        /*if($user->email != $user->temp_email){
            ...
            return redirect('/profilemember/{id}' . $id)->with('success', 'Profile Updated');
        //}
    }
