...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="template2/img/favicon/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="template2/img/favicon/apple-touch-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72" href="template2/img/favicon/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="template2/img/favicon/apple-touch-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="template2/img/favicon/apple-touch-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="template2/img/favicon/apple-touch-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="template2/img/favicon/apple-touch-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152" href="template2/img/favicon/apple-touch-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180" href="template2/img/favicon/apple-touch-icon-180x180.png">
	<link rel="icon" type="image/png" href="template2/img/favicon/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="template2/img/favicon/favicon-194x194.png" sizes="194x194">
	<link rel="icon" type="image/png" href="template2/img/favicon/favicon-96x96.png" sizes="96x96">
	<link rel="icon" type="image/png" href="template2/img/favicon/android-chrome-192x192.png" sizes="192x192">
	<link rel="icon" type="image/png" href="template2/img/favicon/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="template2/img/favicon/manifest.json">
	<link rel="mask-icon" href="template2/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
	<link rel="shortcut icon" href="template2/img/favicon/favicon.ico">
	<meta name="msapplication-TileColor" content="#66e0e5">
	<meta name="msapplication-TileImage" content="template2/img/favicon/mstile-144x144.png">
	<meta name="msapplication-config" content="template2/img/favicon/browserconfig.xml">
	<meta name="theme-color" content="#ffffff">
	<!-- end favicon links -->
	<link rel="stylesheet" href="template2/css/bootstrap.min.css" />
	<link rel="stylesheet" href="template2/css/normalize.min.css">
	<link rel="stylesheet" href="template2/css/animate.min.css">
	<link rel="stylesheet" href="template2/css/flickity.min.css">
	<link rel="stylesheet" href="template2/css/styles.css">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/template2/css/font-awesome.min.css">
</head>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="header-nav-wrapper">
				<div class="logo">
					<a href="/index.html"><template2/img src="template2/img/synthetica-logo.png" alt="Synthetica Freebie"></a>
				</div>
	...
	<header class="hero">
		<div class="carousel js-flickity">
			<div class="carousel-cell" style="background-image: url(template2/img/hero-bg-01.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
			...
			<div class="carousel-cell" style="background-image: url(template2/img/hero-bg-02.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center">
			...
			<div class="carousel-cell" style="background-image: url(template2/img/hero-bg-03.jpg);">
				<div class="hero-bg">
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center">
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="video-player">
						<video id="video_synth" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="568" height="300" poster="template2/img/video-cover.jpg" data-setup='{}'>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<article class="crew-member" style="background-image: url(template2/img/crew-peter-finlan.jpg)">
						<figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<article class="crew-member" style="background-image: url(template2/img/crew-blaz-robar.jpg)">
						<figure>
							<figcaption class="overlay">
								<h2>Blaz Robar</h2>
								<p>8-bit aesthetic kitsch 90's humblebrag. Gastropub tacos hoodie letterpress.</p>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<article class="crew-member" style="background-image: url(template2/img/crew-mary-lou.jpg)">
						<figure>
							<figcaption class="overlay">
								<h2>Mary Lou</h2>
								<p>8-bit aesthetic kitsch 90's humblebrag. Gastropub tacos hoodie letterpress.</p>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<article class="crew-member" style="background-image: url('template2/img/crew-dude.jpg')">
						<figure>
							<figcaption class="overlay">
								<h2>Kobe West</h2>
								<p>8-bit aesthetic kitsch 90's humblebrag. Gastropub tacos hoodie letterpress.</p>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-01.jpg)">
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-02.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-03.jpg)">
							</div>
							<figure>
								<figcaption>
			...
			<div class="row has-top-margin">
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-04.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-05.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-4">
					<article class="article-post">
						<a href="#">
							<div class="article-image has-overlay" style="background-image: url(template2/img/article-06.jpg)">
							</div>
							<figure>
								<figcaption>
				...
				<div class="col-md-6 no-padding">
					<article class="item wp5">
						<figure class="has-overlay">
							...
							<template2/img src="template2/img/sedna-freebie.jpg" alt="Sedna Freebie">
						</figure>
					</article>
				</div>
				<div class="col-md-6 no-padding">
					<article class="item wp6">
						<figure class="has-overlay">
							...
							<template2/img src="template2/img/landio-freebie.jpg" alt="Land.io Freebie">
						</figure>
					</article>
				</div>
			</div>
				...
				<div class="col-md-6 no-padding">
					<article class="item wp7">
						<figure class="has-overlay">
							...
							<template2/img src="template2/img/freebie-03.jpg" alt="Synthetica Freebie">
						</figure>
					</article>
				</div>
				<div class="col-md-6 no-padding">
					<article class="item wp8">
						<figure class="has-overlay">
							...
							<template2/img src="template2/img/freebie-04.jpg" alt="Synthetica">
						</figure>
					</article>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 footer-branding">
					<template2/img class="footer-branding-logo" src="template2/img/synthetica-logo.png" alt="Synthetica freebie html5 css3 template logo">
	...
	<!-- JS Locals -->
	<script src="template2/js/min/bootstrap.min.js"></script>
	<script src="template2/js/min/modernizr-2.8.3-respond-1.4.2.min.js"></script>
	<script src="template2/js/min/retina.min.js"></script>
	<script src="template2/js/min/jquery.waypoints.min.js"></script>
	<script src="template2/js/min/flickity.pkgd.min.js"></script>
	<script src="template2/js/min/scripts-min.js"></script>
