                        ...
                        <ul id="portfolio-list">
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img1.jpg') }}" class="img-responsive" alt="" />
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img2.jpg') }}" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img3.jpg') }}" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img4.jpg') }}" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img5.jpg') }}" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="{{ asset('template/images/portfolio/img6.jpg') }}" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="{{ asset('template/images/about-01.jpg') }}" class="img-responsive" alt="..">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="{{ asset('template/images/about-02.jpg') }}" class="img-responsive" alt="..">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="{{ asset('template/images/about-03.jpg') }}" class="img-responsive" alt="..">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="carousel-example-generic" class="carousel slide about-slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="{{ asset('template/images/about-01.jpg') }}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('template/images/about-02.jpg') }}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('template/images/about-03.jpg') }}" alt="">
                            </div>
            ...
            <div id="testimonial-carousel" class="testimonials-carousel">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="{{ asset('template/images/testimonial/face_1.png') }}" alt="" >
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="{{ asset('template/images/testimonial/face_2.png') }}" alt="" >
                        <div class="testimonial-author">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="{{ asset('template/images/testimonial/face_3.png') }}" alt="" >
                        <div class="testimonial-author">
                            <div class="author">John Doe</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="clients">
                    ...
                    <div class="col-md-12">
                        <img src="{{ asset('template/images/logos/themeforest.jpg') }}" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="{{ asset('template/images/logos/creative-market.jpg') }}" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="{{ asset('template/images/logos/designmodo.jpg') }}" class="img-responsive" alt="...">
                    </div>
                    ...
                    <div class="col-md-12">
                        <img src="{{ asset('template/images/logos/microlancer.jpg') }}" class="img-responsive" alt="...">
                    </div>
